...
http_archive(
    name = "org_tensorflow",
    sha256 = "fd6fae5aa9014cb898c1cca1e44158d0d0ba5cbe9385eab50a1c3f62660fa101", # sha256sum
    strip_prefix = "tensorflow-2.9.0",
    urls = ["https://github.com/tensorflow/tensorflow/archive/refs/tags/v2.9.0.zip"],
